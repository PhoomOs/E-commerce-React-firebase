        ...
        <div>
          ...
          <InputGroup>
            <td>
              ...
              <Col>
                <div>
                  <Card style={{ width: 220, height: 220, backgroundColor: 'white' }}>
                    <CardTitle style={{ position: 'absolute', top: 15, left: 50 }}>
                      Category
      </CardTitle>
                    <CardBody style={{ marginLeft: 10 }}>
                      <Button style={{ position: 'absolute', top: 65, left: 50 }} color="secondary">something</Button><br />
                      <Button style={{ position: 'absolute', top: 115, left: 50 }} color="secondary">something</Button><br />
                      <Button style={{ position: 'absolute', top: 165, left: 50 }} color="secondary">something</Button>
                    </CardBody>
                  </Card>
                </div>
              </Col>
