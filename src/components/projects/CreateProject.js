...
import { Radio, FormControlLabel, RadioGroup, FormControl, FormLabel } from '@material-ui/core';
                ...
                <form onSubmit={this.handleSubmit} className='white'>
                    ...
                    <div className="input-field">
                        ...
                        <fieldset>
                            ...
                            <p>
                                <label>
                                    <input class="with-gap" name="gender" type="radio" id='catValue' value='Mouse' onChange={this.handleChange} />
                                    <span>Mouse</span>
                                </label><br/>
                                <label>
                                    <input class="with-gap" name="gender" type="radio" id='catValue' value='Keyboard' onChange={this.handleChange} />
                                    <span>Keyboard</span>
                                </label><br/>
                                <label>
                                    <input class="with-gap" name="gender" type="radio" id='catValue' value='Hardware' onChange={this.handleChange} />
                                    <span>Hardware</span>
                                </label>
                            </p>
                        </fieldset>
